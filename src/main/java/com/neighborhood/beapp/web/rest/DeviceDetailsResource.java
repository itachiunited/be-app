...
import com.neighborhood.beapp.repository.search.DeviceDetailsSearchRepository;
...
/**
 * REST controller for managing {@link com.neighborhood.beapp.domain.DeviceDetails}.
 */
@RestController
@RequestMapping("/api")
public class DeviceDetailsResource {
    ...
    private static final String ENTITY_NAME = "beAppDeviceDetails";
